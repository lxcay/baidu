...
public interface GroupListener extends GotyeListener {
	 ...
	 * 
	 * @param code
	 *            状态码 参见 {@link com.gotye.api.GotyeStatusCode}
	 * @param group
	 *            被创建的群
	 */
	 ...
	 *            所在群
	 */
	void onKickoutGroupMember(int code, GotyeGroup group, GotyeUser kickedMember);
	 ...
	 *            群对象
	 */
	void onGetGroupDetail(int code, GotyeGroup group);
	 ...
	 *            页码
	 */
	void onGetGroupMemberList(int code, GotyeGroup group, int pagerIndex,
                              List<GotyeUser> allList, List<GotyeUser> curList);
	 ...
	 *            邀请信息
	 */
	void onReceiveGroupInvite(int code, GotyeGroup group, GotyeUser sender,
                              String message);
	 ...
	 *            请求信息
	 */
	void onReceiveRequestJoinGroup(int code, GotyeGroup group,
	 ...
	 *            是否同意
	 */
	void onReceiveReplayJoinGroup(int code, GotyeGroup group, GotyeUser sender,
	 ...
	 *            所在群
	 */
	void onChangeGroupOwner(int code, GotyeGroup group, GotyeUser newOwner);
	 ...
	 *            操作人
	 */
	void onUserKickedFromGroup(GotyeGroup group, GotyeUser kicked,
                               GotyeUser actor);
